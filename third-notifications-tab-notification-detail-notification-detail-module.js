...
let NotificationDetailComponent = class NotificationDetailComponent {
    constructor(activatedRoute, notificationService) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header [translucent]=\"true\">\n  <ion-toolbar color=\"success\">\n    <ion-tab-button tab=\"notifications\" style=\"float: left; background: transparent\">\n      <ion-icon size=\"large\" color=\"light\" name=\"arrow-back-outline\"></ion-icon>\n    </ion-tab-button>\n    <ion-title class=\"ion-text-start\">Оповещение</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content class=\"ion-padding\">\n  <ion-row>\n    <ion-col size-md=\"6\" offset-md=\"3\">\n      <ion-label>\n        <h2>{{ loadedNotification.title }}</h2>\n        <ion-label color=\"medium\">\n          <h6>{{ loadedNotification.date }}</h6>\n        </ion-label>\n        <p>{{ loadedNotification.text }}</p>\n      </ion-label>\n    </ion-col>\n  </ion-row>\n</ion-content>\n");
